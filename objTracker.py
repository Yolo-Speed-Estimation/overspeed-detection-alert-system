...
# SPEED RECORD
file = open("C://SDS//TrafficRecord//SpeedRecord.txt", "w")
file.write("------------------------------\n")
file.write("            REPORT            \n")
file.write("------------------------------\n")
file.write("ID  |   SPEED\n------------------------------\n")
...
class EuclideanDistTracker:
    ...
    def capture(self, img, x, y, h, w, sp, id):
        if(self.capf[id] == 0):
            ...
            file = 'C://SDS//TrafficRecord//' + n + '.jpg'
            cv2.imwrite(file, crop_img)
            self.count += 1
            fileTR = open("C://SDS//TrafficRecord//SpeedRecord.txt", "a")
            if(sp > limit):
                fileEX = 'C://SDS//TrafficRecord//exceeded//' + n + '.jpg'
    ...
    def datavis(self, id_lst, spd_lst):
        ...
        plt.savefig("C://SDS//TrafficRecord//datavis.png", bbox_inches ='tight', pad_inches =1, edgecolor ='w', orientation ='landscape')
    ...
    # TEXT FILE SUMMARY
    def end(self):
        file = open("C://SDS//TrafficRecord//SpeedRecord.txt", "a")
        file.write("\n------------------------------\n")
        file.write("           SUMMARY            \n")
        file.write("------------------------------\n")
